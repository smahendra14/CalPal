    ...
    return (
        <div className="container">
            ...
            <h1 className="header-text">
                ...
                <span className="special-header-text">
                    speaks your language
                </span>
            </h1>
            <div className="description-container">
                <h3 className="description-text">
                    CalPal converts natural language descriptions into events on
                    your Google Calendar so creating events is now as easy as
                    typing "practice coding on the 25th at 9 am"
                </h3>
